    ...
    <div id="content" class="mw-body" role="main">
        ...
        <div id="listening">
            <div style="float:right">
             ...
             <h3>You are listening</h3><small><a href="https://meta.wikimedia.org/w/index.php?title=Wikiradio_(tool)/playlist/<?php echo isset($_GET['channel'])?($_GET['channel']):(('classic')); ?>&action=edit">[Edit dayparting]</a></small>
